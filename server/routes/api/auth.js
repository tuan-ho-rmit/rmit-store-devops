...
router.post('/register', async (req, res) => {
  try {
    ...
    if (isSubscribed) {
      const result = await mailchimp.subscribeToNewsletter(email); // Email notification logic is a work in progress, ignore this for now
...
router.post('/reset/:token', async (req, res) => {
  try {
    ...
    await mailgun.sendEmail(resetUser.email, 'reset-confirmation'); // Email notification logic is a work in progress, ignore this for now
...
router.post('/reset', auth, async (req, res) => {
  try {
    ...
    await mailgun.sendEmail(existingUser.email, 'reset-confirmation'); // Email notification logic is a work in progress, ignore this for now
